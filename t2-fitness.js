(()=>{
      const REGISTRATION_URL = '#claim'; // Replace with the dedicated T2 Fitness registration URL.
      ...
      document.querySelectorAll('.js-offer').forEach(a=>a.addEventListener('click',()=>window.dataLayer?.push({event:'t2_fitness_offer_click',cta:a.textContent.trim()})));
    })();
