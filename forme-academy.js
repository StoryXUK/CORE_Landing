(()=>{
      const REGISTRATION_URL = '#claim'; // Replace with the dedicated FORME Academy registration URL.
      ...
      document.querySelectorAll('.js-offer').forEach(a=>a.addEventListener('click',()=>window.dataLayer?.push({event:'forme_academy_offer_click',cta:a.textContent.trim()})));
    })();
