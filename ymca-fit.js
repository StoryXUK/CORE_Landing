(()=>{
      const REGISTRATION_URL = '#claim'; // Replace with the dedicated YMCAfit registration URL.
      ...
      document.querySelectorAll('.js-offer').forEach(a=>a.addEventListener('click',()=>window.dataLayer?.push({event:'ymca_fit_offer_click',cta:a.textContent.trim()})));
    })();
